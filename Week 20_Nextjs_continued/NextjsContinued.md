...
- [**Next.js continued**](#nextjs-continued)
  - [**What we've convered**](#what-weve-convered)
  - [**Route Groups ()**](#route-groups)
  - [**Dynamic routes \[\]**](#dynamic-routes)
  - [**\[...\] Catch-All Segment**](#-catch-all-segment)
    - [**Catch-All \[\[...slug\]\]**](#catch-all-slug)
  - [**Static Site Generation**](#static-site-generation)
  - [**Server side rendering V/S Client side rendering V/S Static site generation**](#server-side-rendering-vs-client-side-rendering-vs-static-site-generation)
    - [**Client side rendering**](#client-side-rendering)
    - [**Server side rendering**](#server-side-rendering)
    - [**Static site generation**](#static-site-generation-1)
  - [**Client components V/S Server components**](#client-components-vs-server-components)
    - [**When to use which ??**](#when-to-use-which)
    - [**Some official documentation**](#some-official-documentation)
  - [**Hydration**](#hydration)
...
## **Client components V/S Server components**
----------
